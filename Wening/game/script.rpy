...
image bg fazle_office_sore = im.Scale("backgrounds/Fazle _office_sore.png", 1920, 1080)
image bg fazle_office_pagi = im.Scale("backgrounds/Fazle _office_pagi.png", 1920, 1080)
image bg fazle_office_malam = im.Scale("backgrounds/Fazle _office_malam.jpg", 1920, 1080)
...
label start:
    ...
    show bg fazle_office_pagi with fade
    ...
    pe "Saudara Fazle, itu pidato yang indah. Tapi izinkan saya bertanya: apakah Anda tahu betapa sulitnya membawa perubahan dalam sistem yang sudah mapan ini?"
    ...
    scene bg fazle_office_sore with fade  # Background: ruang kerja Fazle 
    ...
    scene bg fazle_office_malam with fade
    show b happy at Position(xpos=0.3, ypos=2.0) with dissolve
    ...
    scene bg Fazle _office_malam with fade
    ...
    menu :
        ...
        "Meminta buruh untuk berbicara langsung sebagai saksi." :
            b "Saya... saya ingin mengatakan bahwa semua yang dikatakan Pak Fazle itu benar. Kami sering dipaksa bekerja melebihi batas, dan gaji kami dipotong tanpa alasan."
